...
import logo2 from "../assets/NL.png";
...
function Nav() {
  ...
  return (
    <div className="w-full h-[80px] bg-[#ffffff] fixed top-0 shadow-lg flex justify-between md:justify-around items-center px-[10px] left-0 z-[80]">
      <div className="flex justify-center items-center gap-[10px] ">
        ...
        {!activeSearch && (
          <div>
            <IoSearchSharp
              className="w-[23px] h-[23px] text-gray-800 lg:hidden"
              onClick={() => setActiveSearch(true)}
            />
          </div>
        )}
        {searchData.length > 0 && (
          <div className="absolute top-[90px] h-[500px] left-[0px] lg:left-[20px] shadow-lg w-[100%] lg:w-[700px] bg-[#ffffff] flex flex-col gap-[20px] p-[20px] overflow-auto">
            {searchData.map((sea) => (
              <div
              ...
              >
                ...
                <div>
                  <div className="text-[19px] font-semibold text-gray-800">{`${sea.firstName} ${sea.lastName}`}</div>
